...
hw_cfg = {
    # DAC
    "qubit_ch": [7]*6,  # Qubit Channel Port, Full-speed DAC
...
readout_cfg = {
    "trig_time": 0.49,  # [Clock ticks] - get this value from TOF experiment
    "ro_length": 2.0,  # [us]
    "mixer_freq": 5600.0,  # [MHz] - used for mux_ch and interpolated_ch

    # Changes related to the resonator output channel
    "res_freq_ge": [5796.71,5796.71, 5796.71, 5796.71, 5796.71, 5796.71],  # [MHzx]
...
qubit_cfg = {
    ...
    "qubit_freq_ge": [4606.74, 4606.74, 4606.74, 4606.74, 4606.74, 4606.74],
    "qubit_mixer": [4606.74, 4606.74, 4606.74, 4606.74, 4606.74, 4606.74],
    "qubit_gain_ge": [0.05, 0.05, 0.05, 0.05, 0.05],
    ...
    "sigma": [0.005, 0.005, 0.005, 0.005, 0.005, 0.005],
    # [us] for Gaussian Pulse

...
readout_cfg = {
    "trig_time": 0.5,  # [Clock ticks] - get this value from TOF experiment
    "ro_length": 5.0,  # [us]
...
qubit_cfg = {
    ...
    # digital mixer #[MHz]
    "qubit_mixer_freq_ge": [4000, 4000, 4000, 4000, 4000, 4000],
    "qubit_mixer_freq_ef": [4000, 4000, 4000, 4000, 4000, 4000],
    "qubit_phase": 0,  # [deg]
    # [us] for Gaussian Pulse
    "sigma_ge": [0.1 / 5, 0.1 / 5, 0.1 / 5, 0.1 / 5, 0.1 / 5, 0.1 / 5],

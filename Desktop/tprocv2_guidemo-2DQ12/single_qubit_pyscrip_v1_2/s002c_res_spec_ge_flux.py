...
from .module_fitzcu import resonator_circlefit, post_rotate
...
class Resonator_onetone_flux:
    ...
    def liveplot_yoko(self, py_avg, yoko_currnet:np.ndarray, yoko_inst:str=None):
        ...
        # except:
        #     import sys
        #     sys.exit("Cannot connect to Yokogawa")
        ...
        for idx, curr in tqdm(enumerate(yoko_currnet)):
            ...
            ax.set_title(f"Resonator Onetone Flux current ={curr*1e3:.3f}mA : {idx+1}/{len(yoko_currnet)}")

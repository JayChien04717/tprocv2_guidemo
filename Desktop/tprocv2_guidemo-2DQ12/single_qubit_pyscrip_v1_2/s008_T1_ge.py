...
from .plot_utils import plot_final, plot_final2
...
class T1:
    ...
    def liveplot(self, py_avg):
        ...
        fig.suptitle(f"T1 = {fit_params[2]:.2f} +-{error[2]:.2f}$\mu s$", fontsize=15)
        fig.tight_layout()
        ...
        fig.savefig(os.path.join(fig_dir, "T1_ge.png"), dpi=300, bbox_inches="tight")
